...
<b>Tired of writing (or generating) lengthy, boilerplate code for objects which do nothing but store data?
	Well, Kotlin has the solution for you! </b> 
